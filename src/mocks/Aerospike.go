...
import (
	...
	aerospike "github.com/africarealty/server/src/kit/storages/aerospike"
...
// GetKey provides a mock function with given fields: ctx, ns, key
func (_m *Aerospike) GetKey(ctx context.Context, ns string, key interface{}) (*v6.Key, error) {
	ret := _m.Called(ctx, ns, key)

	var r0 *v6.Key
	if rf, ok := ret.Get(0).(func(context.Context, string, interface{}) *v6.Key); ok {
		r0 = rf(ctx, ns, key)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v6.Key)
