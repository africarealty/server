...
type mockConstructorTestingTNewUserRegistrationUseCase interface {
	mock.TestingT
	Cleanup(func())
}

// NewUserRegistrationUseCase creates a new instance of UserRegistrationUseCase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewUserRegistrationUseCase(t mockConstructorTestingTNewUserRegistrationUseCase) *UserRegistrationUseCase {
