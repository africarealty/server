...
type ErrGroup interface {
	...
	WithLogger(logger log.CLogger) ErrGroup
	// WithLoggerFn allows specify logger func
	WithLoggerFn(loggerFn log.CLoggerFunc) ErrGroup
...
func (g *errGroup) WithLogger(logger log.CLogger) ErrGroup {
	g.logger = logger
	return g
}

func (g *errGroup) WithLoggerFn(loggerFn log.CLoggerFunc) ErrGroup {
	g.loggerFn = loggerFn
	return g
}
