...
func (_m *ErrGroup) WithLogger(logger log.CLogger) goroutine.ErrGroup {
	ret := _m.Called(logger)

	var r0 goroutine.ErrGroup
	if rf, ok := ret.Get(0).(func(log.CLogger) goroutine.ErrGroup); ok {
		r0 = rf(logger)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(goroutine.ErrGroup)
...
func (_m *ErrGroup) WithLoggerFn(loggerFn log.CLoggerFunc) goroutine.ErrGroup {
	ret := _m.Called(loggerFn)

	var r0 goroutine.ErrGroup
	if rf, ok := ret.Get(0).(func(log.CLoggerFunc) goroutine.ErrGroup); ok {
		r0 = rf(loggerFn)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(goroutine.ErrGroup)
